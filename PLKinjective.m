...
%                                                                           %
%                                                                           %
% OUTPUT: Returns whether the chemical reaction network (CRN) is injective  %
%    or not. The output variables 'injective', 'det_Mstar', and 'model'     %
...
%    2. Ideas for some parts of the code was motivated by [2].              %
%                                                                           %
% References                                                                %
...
function [injective, det_Mstar, model] = PLKinjective(model)
